 ...
 * Cookie管理工具
 */
public class CookieManager extends Provider{
	/** 失效时间  */
	 ...
	 * 
	 * @param path
	 *            The path for which the cookie is active (defaults to root '/'
	 *            which makes it active for all pages in the site)
	 * @param expires
	 *            the cookie expiration date (defaults to 7 days from now)
	 * @param domain
	 *            The domain to save the cookie for. Note that you cannot
	 *            specify a different domain than your page is on, but you can
	 *            specify a sub-domain.
	 * @param secure
	 *            <code>true</code> if the site is using SSL
	 */
	public CookieManager(String path, Date expires, String domain,
			boolean secure) {
