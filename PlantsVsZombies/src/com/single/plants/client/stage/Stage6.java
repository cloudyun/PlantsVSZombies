...
public class Stage6 extends StageView implements PVZResources {

	private Shovel shovel;

	public Stage6(Controller controller) {
		super(controller);
	}
	...
	protected void initialize() {
		...
		topCards.add(SnowPea.get().createCard());
